...
class Db():
    ...
    def __popular_tabelas(self):
        ...
        self.__cursor.execute("""INSERT INTO Animais (name, type, rescue_date, adoption_date, porte, vaccinated, approximate_age)
                                    VALUES ('Luke', 'DOG', '2019-01-05', 'NULL', 'XG', 'Y', 3)""")
        self.__cursor.execute("""INSERT INTO Animais (name, type, rescue_date, adoption_date, porte, vaccinated, approximate_age)
                                    VALUES ('Thor', 'DOG', '2018-12-15', 'NULL', 'XG', 'Y', 10)""")
        self.__cursor.execute("""INSERT INTO Animais (name, type, rescue_date, adoption_date, porte, vaccinated, approximate_age)
                                    VALUES ('Jess', 'CAT', '2018-09-08', '2019-04-03', 'XG', 'Y', 1)""")
        self.__cursor.execute("""INSERT INTO Animais (name, type, rescue_date, adoption_date, porte, vaccinated, approximate_age)
                                    VALUES ('Matt', 'DOG', '2018-09-08', 'NULL', 'XG', 'Y', 1)""")
        self.__conn.commit()
    ...
    def insert_animais(self, name, typeA, rescue_date, adoption_date, porte, vaccinated, approximate_age):
        self.__cursor.execute("""INSERT INTO Animais (name, type, rescue_date, adoption_date, porte, vaccinated, approximate_age)
                                 VALUES (?, ?, ?, ?, ?, ?, ?)""",
                                 (name, typeA, rescue_date, adoption_date, porte, vaccinated, approximate_age))
        self.__conn.commit()
...
if __name__ == '__main__':
    db = Db('teste.db')
    db.create_env()
    db.insert_cliente('Name', 'last_name', '987896541', 'N', 'email@email.com', '11898784566')
